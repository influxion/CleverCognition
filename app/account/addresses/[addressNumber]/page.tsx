...
import { deleteAddress, updateAddress, updateDefaultAddress } from './action';
...
export default async function EditAddressPage({
  ...
  const customer = await getCustomerWithRevalidate({ path: `/account/addresses/${addressNumber}` });
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <form action={updateDefaultAddress}>
