      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
        {customer.addresses.length
          ? customer.addresses.map((address) => (
              <div className="relative flex flex-col gap-1 rounded border p-6">
          ...
          : null}
        <div className="relative flex flex-col gap-2 justify-center items-center rounded border p-6">
