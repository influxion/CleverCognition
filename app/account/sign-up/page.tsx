    ...
    <div className="mx-auto my-20 flex min-h-[50vh] max-w-7xl justify-center">
      ...
      >
        ...
        <div className="flex w-full gap-4">
          <Input name="first-name" placeholder="First Name (Optional)" className="w-full" />
          <Input name="last-name" placeholder="Last Name (Optional)" className="w-full" />
        </div>
        ...
        <SubmitButton className="mt-8">Sign Up</SubmitButton>
      </form>
    </div>
  );
}
